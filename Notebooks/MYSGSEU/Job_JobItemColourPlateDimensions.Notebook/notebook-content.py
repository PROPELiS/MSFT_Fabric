...
silver_path="abfss://SGSCo_Fabric_Development@onelake.dfs.fabric.microsoft.com/SILVER.Lakehouse/Tables/dbo/job_jobitemcolourplatedimensions"
...
if in_mode == "FULL":
    ...
    df.write.format("delta").mode("overwrite").saveAsTable("Job_JobItemColourPlateDimensions")

    bronze_Path ="abfss://SGSCo_Fabric_Development@onelake.dfs.fabric.microsoft.com/BRONZE.Lakehouse/Tables/MYSGSEU/Job_JobItemColourPlateDimensions_FULL"
    ...
    df.write.format("delta").mode("append").saveAsTable("Job_JobItemColourPlateDimensions")
    
    source_path = "abfss://SGSCo_Fabric_Development@onelake.dfs.fabric.microsoft.com/BRONZE.Lakehouse/Tables/MYSGSEU/Job_JobItemColourPlateDimensions_DELTA"
...
df = spark.sql("SELECT COUNT(*) FROM SILVER.dbo.job_jobitemcolourplatedimensions")
display(df)
