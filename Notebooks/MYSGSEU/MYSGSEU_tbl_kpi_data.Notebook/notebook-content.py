...
silver_path="abfss://Propelis_Fabric_Production@onelake.dfs.fabric.microsoft.com/SILVER.Lakehouse/Tables/MYSGSEU/tbl_kpi_data"
...
if in_mode == "FULL":
    ...
    df.write.format("delta").mode("overwrite").saveAsTable("MYSGSEU.tbl_kpi_data")
    bronze_Path ="abfss://Propelis_Fabric_Production@onelake.dfs.fabric.microsoft.com/BRONZE.Lakehouse/Tables/MYSGSEU/tbl_kpi_data_FULL"
    ...
    df.write.format("delta").mode("append").saveAsTable("MYSGSEU.tbl_kpi_data")
    
    source_path = "abfss://Propelis_Fabric_Production@onelake.dfs.fabric.microsoft.com/BRONZE.Lakehouse/Tables/MYSGSEU/tbl_kpi_data_DELTA"
