...
bronze_Path ="abfss://SGSCo_Fabric_Development@onelake.dfs.fabric.microsoft.com/BRONZE.Lakehouse/Tables/MYSGSEU/tbl_package_type_FULL"
silver_path="abfss://SGSCo_Fabric_Development@onelake.dfs.fabric.microsoft.com/SILVER.Lakehouse/Tables/dbo/tbl_package_type"
...
if in_mode == "FULL":
    df.write.format("delta").mode("overwrite").saveAsTable("tbl_package_type")
    ...
    df.write.format("delta").mode("append").saveAsTable("tbl_package_type")
    
   # Define paths
    source_path = "abfss://SGSCo_Fabric_Development@onelake.dfs.fabric.microsoft.com/BRONZE.Lakehouse/Tables/MYSGSEU/tbl_package_type_DELTA"
