...
silver_path="abfss://SGSCo_Fabric_Development@onelake.dfs.fabric.microsoft.com/SILVER.Lakehouse/Tables/dbo/tbl_plate_thickness"
...
if in_mode == "FULL":
    df.write.format("delta").mode("overwrite").saveAsTable("tbl_plate_thickness")
    # Write the DataFrame as a Delta table
    bronze_Path ="abfss://SGSCo_Fabric_Development@onelake.dfs.fabric.microsoft.com/BRONZE.Lakehouse/Tables/MYSGSEU/tbl_plate_thickness_FULL"
    ...
    df.write.format("delta").mode("append").saveAsTable("tbl_plate_thickness")
    
    source_path = "abfss://SGSCo_Fabric_Development@onelake.dfs.fabric.microsoft.com/BRONZE.Lakehouse/Tables/MYSGSEU/tbl_plate_thickness_DELTA"
