...
df = spark.sql("SELECT count(*) FROM SILVER.dbo.tbl_price_matrix_items ")
display(df)
...
silver_path="abfss://SGSCo_Fabric_Development@onelake.dfs.fabric.microsoft.com/SILVER.Lakehouse/Tables/dbo/tbl_price_matrix_items"
...
if in_mode == "FULL":
    ...
    df.write.format("delta").mode("overwrite").saveAsTable("tbl_price_matrix_items")
    bronze_Path ="abfss://SGSCo_Fabric_Development@onelake.dfs.fabric.microsoft.com/BRONZE.Lakehouse/Tables/MYSGSEU/tbl_price_matrix_items_FULL"
    ...
    df.write.format("delta").mode("append").saveAsTable("tbl_price_matrix_items")
    
    source_path = "abfss://SGSCo_Fabric_Development@onelake.dfs.fabric.microsoft.com/BRONZE.Lakehouse/Tables/MYSGSEU/tbl_price_matrix_items_DELTA"
