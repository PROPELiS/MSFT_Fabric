...
silver_path="abfss://SGSCo_Fabric_Development@onelake.dfs.fabric.microsoft.com/SILVER.Lakehouse/Tables/dbo/tbl_proof_colour_management_type_profiles"
...
if in_mode == "FULL":
    ...
    df.write.format("delta").mode("overwrite").saveAsTable("tbl_proof_colour_management_type_profiles")
    bronze_Path ="abfss://SGSCo_Fabric_Development@onelake.dfs.fabric.microsoft.com/BRONZE.Lakehouse/Tables/MYSGSEU/tbl_proof_colour_management_type_profiles_FULL"
    ...
    df.write.format("delta").mode("append").saveAsTable("tbl_proof_colour_management_type_profiles")
    
    source_path = "abfss://SGSCo_Fabric_Development@onelake.dfs.fabric.microsoft.com/BRONZE.Lakehouse/Tables/MYSGSEU/tbl_proof_colour_management_type_profiles_DELTA"
