...
silver_path="abfss://SGSCo_Fabric_Development@onelake.dfs.fabric.microsoft.com/SILVER.Lakehouse/Tables/dbo/tbl_dax_customer_addresses"
...
if in_mode == "FULL":
    ...
    df.write.format("delta").mode("overwrite").saveAsTable("tbl_DAX_customer_addresses")
    bronze_Path ="abfss://SGSCo_Fabric_Development@onelake.dfs.fabric.microsoft.com/BRONZE.Lakehouse/Tables/MYSGSEU/tbl_DAX_customer_addresses_FULL"
   ...
   # Merge data from Bronze Full to Silver
    ...
    df.write.format("delta").mode("append").saveAsTable("tbl_DAX_customer_addresses")
source_path = "abfss://SGSCo_Fabric_Development@onelake.dfs.fabric.microsoft.com/BRONZE.Lakehouse/Tables/MYSGSEU/tbl_DAX_customer_addresses_DELTA"
