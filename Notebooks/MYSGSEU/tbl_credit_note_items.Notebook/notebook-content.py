...
silver_path="abfss://SGSCo_Fabric_Development@onelake.dfs.fabric.microsoft.com/SILVER.Lakehouse/Tables/dbo/tbl_credit_note_items"
...
if in_mode == "FULL":
    ...
    df.write.format("delta").mode("overwrite").saveAsTable("tbl_credit_note_items")

    bronze_Path ="abfss://SGSCo_Fabric_Development@onelake.dfs.fabric.microsoft.com/BRONZE.Lakehouse/Tables/MYSGSEU/tbl_credit_note_items_FULL"
    ...
    df.write.format("delta").mode("append").saveAsTable("tbl_credit_note_items")
    
    source_path = "abfss://SGSCo_Fabric_Development@onelake.dfs.fabric.microsoft.com/BRONZE.Lakehouse/Tables/MYSGSEU/tbl_credit_note_items_DELTA"
...
df = spark.sql("SELECT count(*) FROM SILVER.dbo.tbl_credit_note_items")
display(df)
