...
silver_path="abfss://SGSCo_Fabric_Development@onelake.dfs.fabric.microsoft.com/SILVER.Lakehouse/Tables/dbo/tbl_job_status_audit_trail"
...
if in_mode == "FULL":
    ...
    df.write.format("delta").mode("overwrite").saveAsTable("tbl_job_status_audit_trail")
    bronze_Path ="abfss://SGSCo_Fabric_Development@onelake.dfs.fabric.microsoft.com/BRONZE.Lakehouse/Tables/MYSGSEU/tbl_job_status_audit_trail_FULL"
    ...
    df.write.format("delta").mode("append").saveAsTable("tbl_job_status_audit_trail")
    
    source_path = "abfss://SGSCo_Fabric_Development@onelake.dfs.fabric.microsoft.com/BRONZE.Lakehouse/Tables/MYSGSEU/tbl_job_status_audit_trail_DELTA"
...
df = spark.sql("SELECT COUNT(*) FROM SILVER.dbo.tbl_job_status_audit_trail")
display(df)
...
df = spark.sql("SELECT COUNT(*) FROM BRONZE.MYSGSEU.tbl_job_status_audit_trail_FULL")
display(df)
...
df = spark.sql("SELECT * FROM BRONZE.MYSGSEU.tbl_job_status_audit_trail_DELTA")
display(df)
