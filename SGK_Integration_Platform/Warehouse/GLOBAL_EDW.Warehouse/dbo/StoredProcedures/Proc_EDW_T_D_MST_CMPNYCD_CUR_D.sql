CREATE     PROCEDURE [dbo].[Proc_EDW_T_D_MST_CMPNYCD_CUR_D]
AS
BEGIN
    ...
    SET
        ...
        T.[Company Line Of Business]                = S.[LINE_OF_BIZ_CD],
        T.[Company Line Of Business Description]    = S.[LINE_OF_BIZ_CD_DESC],
        ...
        T.[Company Input Tax Code]                  = S.[INPUT_TAX_CD],
    ...
    FROM [GLOBAL_EDW].[dbo].[EDW_T_D_MST_CMPNYCD_CUR_D] AS T
    INNER JOIN [GLOBAL_EDW_MIRROR].[dbo].[EDW_T_D_MST_CMPNYCD_CUR_D] AS S
        ON T.[CMPNY_KEY] = S.[CMPNY_KEY];

    
    INSERT INTO [GLOBAL_EDW].[dbo].[EDW_T_D_MST_CMPNYCD_CUR_D] (
        [CMPNY_KEY],
        [Company Code],
        [Legacy Company Code],
        [Company Name],
    ...
    LEFT JOIN [GLOBAL_EDW].[dbo].[EDW_T_D_MST_CMPNYCD_CUR_D] AS T
        ON T.[CMPNY_KEY] = S.[CMPNY_KEY]
