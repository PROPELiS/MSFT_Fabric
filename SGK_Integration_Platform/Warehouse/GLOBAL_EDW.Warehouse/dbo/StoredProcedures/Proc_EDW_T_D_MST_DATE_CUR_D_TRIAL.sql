CREATE   PROCEDURE dbo.Proc_EDW_T_D_MST_DATE_CUR_D_TRIAL
AS
BEGIN
    ...
    HASHBYTES('SHA2_256',
			CONCAT(
        ISNULL(CONVERT(VARCHAR(20), S.[DATE_KEY]), ''), '|',
        ISNULL(CONVERT(VARCHAR(50), S.[THE_DATE]), ''), '|',
        ISNULL(CONVERT(VARCHAR(20), S.[FISCAL_YR]), ''), '|',
        ISNULL(CONVERT(VARCHAR(20), S.[FISCAL_PER_NUM]), ''), '|',
        ISNULL(S.[FISCAL_PER_CD], ''), '|',
        ISNULL(CONVERT(VARCHAR(20), S.[FISCAL_QTR_NUM]), ''), '|',
        ISNULL(S.[FISCAL_QTR_CD], ''), '|',
        ISNULL(CONVERT(VARCHAR(20), S.[CLNDR_YR]), ''), '|',
        ISNULL(CONVERT(VARCHAR(20), S.[CLNDR_MNTH_NUM]), ''), '|',
        ISNULL(S.[CLNDR_MNTH_CD], ''), '|',
        ISNULL(S.[CLNDR_MNTH_DESC], ''), '|',
        ISNULL(CONVERT(VARCHAR(20), S.[CLNDR_QTR_NUM]), ''), '|',
        ISNULL(S.[CLNDR_QTR_CD], ''), '|',
        ISNULL(CONVERT(VARCHAR(20), S.[CLNDR_WEEKDAY_NUM]), ''), '|',
        ISNULL(S.[CLNDR_WEEKDAY_NAME], ''), '|',
        ISNULL(CONVERT(VARCHAR(20), S.[CLNDR_DAY_IN_MNTH]), ''), '|',
        ISNULL(CONVERT(VARCHAR(20), S.[CLNDR_DAY_IN_YR]), ''), '|',
        ISNULL(CONVERT(VARCHAR(20), S.[CLNDR_WK]), ''), '|',
        ISNULL(CONVERT(VARCHAR(20), S.[CLNDR_MNTH_IN_QTR_NUM]), ''), '|',
        ISNULL(CONVERT(VARCHAR(20), S.[CLNDR_DAYS_IN_MNTH]), ''), '|',
        ISNULL(S.[ETL_SRC_SYS_CD], ''), '|',
        ISNULL(CONVERT(VARCHAR(50), S.[ETL_CREATED_TS]), ''), '|',
        ISNULL(CONVERT(VARCHAR(50), S.[ETL_UPDTD_TS]), ''), '|',
        ISNULL(CONVERT(VARCHAR(1), S.[CURR_DAY_FLG]), ''), '|',
        ISNULL(CONVERT(VARCHAR(1), S.[CURR_DAY_MINUS_1_FLG]), ''), '|',
        ISNULL(CONVERT(VARCHAR(1), S.[CURR_CLNDR_WK_FLG]), ''), '|',
        ISNULL(CONVERT(VARCHAR(1), S.[CURR_CLNDR_WK_MINUS_1_FLG]), ''), '|',
        ISNULL(CONVERT(VARCHAR(1), S.[CURR_MNTH_FLG]), ''), '|',
        ISNULL(CONVERT(VARCHAR(1), S.[CURR_MNTH_MINUS_1_FLG]), ''), '|',
        ISNULL(CONVERT(VARCHAR(1), S.[CURR_MNTH_MINUS_12_FLG]), ''), '|',
        ISNULL(CONVERT(VARCHAR(1), S.[CURR_QTR_FLG]), ''), '|',
        ISNULL(CONVERT(VARCHAR(1), S.[CURR_QTR_MINUS_1_FLG]), ''), '|',
        ISNULL(CONVERT(VARCHAR(1), S.[CURR_QTR_MINUS_4_FLG]), ''), '|',
        ISNULL(CONVERT(VARCHAR(1), S.[CURR_CLNDR_YR_FLG]), ''), '|',
        ISNULL(CONVERT(VARCHAR(1), S.[CURR_CLNDR_YR_MINUS_1_FLG]), ''), '|',
        ISNULL(CONVERT(VARCHAR(1), S.[CURR_CLNDR_YR_MINUS_2_FLG]), ''), '|',
        ISNULL(CONVERT(VARCHAR(1), S.[CURR_FISCAL_YR_FLG]), ''), '|',
        ISNULL(CONVERT(VARCHAR(1), S.[CURR_FISCAL_YR_MINUS_1_FLG]), ''), '|',
        ISNULL(CONVERT(VARCHAR(1), S.[CURR_FISCAL_YR_MINUS_2_FLG]), ''), '|',
        ISNULL(CONVERT(VARCHAR(1), S.[CURR_CLNDR_YR_PLUS_1_FLG]), ''), '|',
        ISNULL(CONVERT(VARCHAR(1), S.[CURR_FISCAL_YR_PLUS_1_FLG]), ''), '|',
        ISNULL(CONVERT(VARCHAR(20), S.[DAY_IN_FISCAL_YR]), ''), '|',
        ISNULL(CONVERT(VARCHAR(1), S.[IS_WEEKDAY]), ''), '|',
        ISNULL(CONVERT(VARCHAR(20), S.[FISCAL_WK]), ''), '|',
        ISNULL(CONVERT(VARCHAR(1), S.[CURR_FISCAL_WK_FLG]), ''), '|',
        ISNULL(CONVERT(VARCHAR(1), S.[CURR_FISCAL_WK_MINUS_1_FLG]), ''), '|',
        ISNULL(CONVERT(VARCHAR(20), S.[FISCAL_WEEKDAY_NUM]), ''), '|',
        ISNULL(S.[FISCAL_WEEKDAY_NAME], ''), '|',
        ISNULL(CONVERT(VARCHAR(1), S.[CURR_MNTH_MINUS_2_FLG]), ''), '|',
        ISNULL(CONVERT(VARCHAR(1), S.[CURR_FISCAL_WK_MINUS_2_FLG]), ''), '|',
        ISNULL(CONVERT(VARCHAR(1), S.[CURR_FISCAL_WK_MINUS_6_FLG]), ''), '|',
        ISNULL(CONVERT(VARCHAR(1), S.[CURR_FISCAL_WK_MINUS_3_FLG]), ''), '|',
        ISNULL(CONVERT(VARCHAR(1), S.[CURR_FISCAL_WK_MINUS_4_FLG]), ''), '|',
        ISNULL(CONVERT(VARCHAR(1), S.[CURR_FISCAL_WK_MINUS_5_FLG]), ''), '|',
        ISNULL(CONVERT(VARCHAR(1), S.[CURR_FISCAL_WK_MINUS_7_FLG]), '')
    )
) AS HashKey
    ...
    WHERE HASHBYTES('SHA2_256',
            CONCAT(
                ISNULL(CONVERT(VARCHAR(20), T.[DATE_KEY]), ''), '|',
                ISNULL(CONVERT(VARCHAR(50), T.[THE_DATE]), ''), '|',
                ISNULL(CONVERT(VARCHAR(20), T.[FISCAL_YR]), ''), '|',
                ISNULL(CONVERT(VARCHAR(20), T.[FISCAL_PER_NUM]), ''), '|',
                ISNULL(T.[FISCAL_PER_CD], ''), '|',
                ISNULL(CONVERT(VARCHAR(20), T.[FISCAL_QTR_NUM]), ''), '|',
                ISNULL(T.[FISCAL_QTR_CD], ''), '|',
                ISNULL(CONVERT(VARCHAR(20), T.[CLNDR_YR]), ''), '|',
                ISNULL(CONVERT(VARCHAR(20), T.[CLNDR_MNTH_NUM]), ''), '|',
                ISNULL(T.[CLNDR_MNTH_CD], ''), '|',
                ISNULL(T.[CLNDR_MNTH_DESC], ''), '|',
                ISNULL(CONVERT(VARCHAR(20), T.[CLNDR_QTR_NUM]), ''), '|',
                ISNULL(T.[CLNDR_QTR_CD], ''), '|',
                ISNULL(CONVERT(VARCHAR(20), T.[CLNDR_WEEKDAY_NUM]), ''), '|',
                ISNULL(T.[CLNDR_WEEKDAY_NAME], ''), '|',
                ISNULL(CONVERT(VARCHAR(20), T.[CLNDR_DAY_IN_MNTH]), ''), '|',
                ISNULL(CONVERT(VARCHAR(20), T.[CLNDR_DAY_IN_YR]), ''), '|',
                ISNULL(CONVERT(VARCHAR(20), T.[CLNDR_WK]), ''), '|',
                ISNULL(CONVERT(VARCHAR(20), T.[CLNDR_MNTH_IN_QTR_NUM]), ''), '|',
                ISNULL(CONVERT(VARCHAR(20), T.[CLNDR_DAYS_IN_MNTH]), ''), '|',
                ISNULL(T.[ETL_SRC_SYS_CD], ''), '|',
                ISNULL(CONVERT(VARCHAR(50), T.[ETL_CREATED_TS]), ''), '|',
                ISNULL(CONVERT(VARCHAR(50), T.[ETL_UPDTD_TS]), ''), '|',
                ISNULL(CONVERT(VARCHAR(1), T.[CURR_DAY_FLG]), ''), '|',
                ISNULL(CONVERT(VARCHAR(1), T.[CURR_DAY_MINUS_1_FLG]), ''), '|',
                ISNULL(CONVERT(VARCHAR(1), T.[CURR_CLNDR_WK_FLG]), ''), '|',
                ISNULL(CONVERT(VARCHAR(1), T.[CURR_CLNDR_WK_MINUS_1_FLG]), ''), '|',
                ISNULL(CONVERT(VARCHAR(1), T.[CURR_MNTH_FLG]), ''), '|',
                ISNULL(CONVERT(VARCHAR(1), T.[CURR_MNTH_MINUS_1_FLG]), ''), '|',
                ISNULL(CONVERT(VARCHAR(1), T.[CURR_MNTH_MINUS_12_FLG]), ''), '|',
                ISNULL(CONVERT(VARCHAR(1), T.[CURR_QTR_FLG]), ''), '|',
                ISNULL(CONVERT(VARCHAR(1), T.[CURR_QTR_MINUS_1_FLG]), ''), '|',
                ISNULL(CONVERT(VARCHAR(1), T.[CURR_QTR_MINUS_4_FLG]), ''), '|',
                ISNULL(CONVERT(VARCHAR(1), T.[CURR_CLNDR_YR_FLG]), ''), '|',
                ISNULL(CONVERT(VARCHAR(1), T.[CURR_CLNDR_YR_MINUS_1_FLG]), ''), '|',
                ISNULL(CONVERT(VARCHAR(1), T.[CURR_CLNDR_YR_MINUS_2_FLG]), ''), '|',
                ISNULL(CONVERT(VARCHAR(1), T.[CURR_FISCAL_YR_FLG]), ''), '|',
                ISNULL(CONVERT(VARCHAR(1), T.[CURR_FISCAL_YR_MINUS_1_FLG]), ''), '|',
                ISNULL(CONVERT(VARCHAR(1), T.[CURR_FISCAL_YR_MINUS_2_FLG]), ''), '|',
                ISNULL(CONVERT(VARCHAR(1), T.[CURR_CLNDR_YR_PLUS_1_FLG]), ''), '|',
                ISNULL(CONVERT(VARCHAR(1), T.[CURR_FISCAL_YR_PLUS_1_FLG]), ''), '|',
                ISNULL(CONVERT(VARCHAR(20), T.[DAY_IN_FISCAL_YR]), ''), '|',
                ISNULL(CONVERT(VARCHAR(1), T.[IS_WEEKDAY]), ''), '|',
                ISNULL(CONVERT(VARCHAR(20), T.[FISCAL_WK]), ''), '|',
                ISNULL(CONVERT(VARCHAR(1), T.[CURR_FISCAL_WK_FLG]), ''), '|',
                ISNULL(CONVERT(VARCHAR(1), T.[CURR_FISCAL_WK_MINUS_1_FLG]), ''), '|',
                ISNULL(CONVERT(VARCHAR(20), T.[FISCAL_WEEKDAY_NUM]), ''), '|',
                ISNULL(T.[FISCAL_WEEKDAY_NAME], ''), '|',
                ISNULL(CONVERT(VARCHAR(1), T.[CURR_MNTH_MINUS_2_FLG]), ''), '|',
                ISNULL(CONVERT(VARCHAR(1), T.[CURR_FISCAL_WK_MINUS_2_FLG]), ''), '|',
                ISNULL(CONVERT(VARCHAR(1), T.[CURR_FISCAL_WK_MINUS_6_FLG]), ''), '|',
                ISNULL(CONVERT(VARCHAR(1), T.[CURR_FISCAL_WK_MINUS_3_FLG]), ''), '|',
                ISNULL(CONVERT(VARCHAR(1), T.[CURR_FISCAL_WK_MINUS_4_FLG]), ''), '|',
                ISNULL(CONVERT(VARCHAR(1), T.[CURR_FISCAL_WK_MINUS_5_FLG]), ''), '|',
                ISNULL(CONVERT(VARCHAR(1), T.[CURR_FISCAL_WK_MINUS_7_FLG]), '')
            )
        ) <> S.HashKey
