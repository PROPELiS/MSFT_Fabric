...
BEGIN  
    ...
    SET
        ...
        T.[Profit Center Generic Master Record Status] = S.[GENERIC_MAST_RCD_STATUS],
        T.[Profit Center Status Description] = S.[STATUS_DESC],
        T.[Profit Center Controlling Area Description] = S.[CONTROLLING_AREA_DESC],
    ...
    -- Insert new records
    INSERT INTO [GLOBAL_EDW].[dbo].[EDW_T_D_MST_PROFCTR_CUR_D] (
        [PROFT_CNTR_KEY],
        [Profit Center ID],
        ...
        [Profit Center Area],
        [Profit Center Generic Master Record Status],
        [Profit Center Status Description],
        [Profit Center Controlling Area Description],
