CREATE       PROCEDURE [Propelis].[Proc_EMPLOYEE_RESP]
AS
BEGIN
    ...
    FROM [GLOBAL_EDW].[Propelis].[EMPLOYEE_RESP] AS T
    ...
    INSERT INTO [GLOBAL_EDW].[Propelis].[EMPLOYEE_RESP] (
    ...
    LEFT JOIN [GLOBAL_EDW].[Propelis].[EMPLOYEE_RESP] AS T
        ON T.[PERSONEL_KEY] = S.[PERSONEL_KEY]
