CREATE     PROCEDURE [Propelis].[Proc_INVOICE]
AS
BEGIN
    ...
    SET
        ...
        T.[Invoice Invoice Pricing Procedure in Pricing] = S.[PRICING_PROC],
        ...
        T.[Invoice Incoterms Description] = S.[INCO_TRMS_DESC],
        ...
        T.[Invoice SD Document Currency Description] = S.[SD_DOCMT_CRNCY_DESC],
        T.[Invoice Cancelled Document Number] = S.[CANCELLED_DOCMT_NUM],
    ...
    FROM [GLOBAL_EDW].[Propelis].[INVOICE] T
    ...
    ----------------------------------------------------------------------
    INSERT INTO [GLOBAL_EDW].[Propelis].[INVOICE] (
        [INVC_KEY],
        ...
        [Invoice Divison],
        [Invoice Invoice Pricing Procedure in Pricing],
    ...
    LEFT JOIN [GLOBAL_EDW].[Propelis].[INVOICE] T
        ON T.[INVC_KEY] = S.[INVC_KEY]
