CREATE     PROCEDURE [Propelis].[Proc_PERSON_RESP_PERSONNEL]
AS
BEGIN
    ...
    FROM [GLOBAL_EDW].[Propelis].[PERSON_RESP_PERSONNEL] AS T
    ...
    INSERT INTO [GLOBAL_EDW].[Propelis].[PERSON_RESP_PERSONNEL] (
                [PERSONEL_KEY],
                [Personnel Number],
                [Company Code],
                [Plant ID],
    ...
    LEFT JOIN [GLOBAL_EDW].[Propelis].[PERSON_RESP_PERSONNEL] AS T
        ON T.[PERSONEL_KEY] = S.[PERSONEL_KEY]
