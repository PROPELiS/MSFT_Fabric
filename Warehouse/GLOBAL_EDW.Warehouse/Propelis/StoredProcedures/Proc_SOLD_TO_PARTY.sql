...
BEGIN
    ...
    FROM [GLOBAL_EDW].[Propelis].[SOLD_TO_PARTY] AS T
    ...
    INSERT INTO [GLOBAL_EDW].[Propelis].[SOLD_TO_PARTY] (
        ...
        [Sold To Party Specific Field Label 01],
        [Sold To Party Specific Field Label 02],
        [Sold To Party Specific Field Label 03],
        [Sold To Party Specific Field Label 04],
        [Sold To Party Specific Field Label 05],
        [Sold To Party Specific Field Label 06],
        [Sold To Party Specific Field Label 07],
        [Sold To Party Specific Field Label 08],
        [Sold To Party Specific Field Label 09],
        [Sold To Party Specific Field Label 10],
        [Sold To Party Specific Field Label 11],
        [Sold To Party Specific Field Label 12],
        [Sold To Party Specific Field Label 13],
        [Sold To Party Specific Field Label 14],
        [Sold To Party Specific Field Label 15],
        [Sold To Party Specific Field Label 16],
        [Sold To Party Specific Field Label 17],
        [Sold To Party Specific Field Label 18],
        [Sold To Party Specific Field Label 19],
        [Sold To Party Specific Field Label 20],
        [Sold To Party Customer Condition Group 1],
        [Sold To Party Industry Code 1],
        [Sold To Party Industry Code 2],
        [Sold To Party Industry Description],
        [Sold To Party Industry Code 1 Description],
        [Sold To Party Industry Code 2 Description],
        [Sold To Party Assign To Hiercarhy],
        [Sold To Party Account Group Description],
        [Sold To Party Region Description],
        [Sold To Party Country Description],
        [Sold To Party Transportation Zone Description],
        [Sold To Party Plant Description],
        [Sold To Party Customer Condition Group Description],
        [Sold To Party Central Billing Block],
        [Sold To Party Central Billing Block Description],
        [Sold To Party Central Delivery Block],
        [Sold To Party Central Delivery Block Description],
        [Sold To Party Deletion Indicator],
        [Sold To Party Central Posting Block],
        [Sold To Party Tax Jurisdiction],
        [Sold To Party Central Sales Block],
        [Sold To Party Central Deletion Indicator],
        [LANG_KEY],
        [Sold To Party Trading Partner],
        [Sold To Party Trading Partner Description],
        [Sold To Party Annual Sales],
        [Sold To Party Annual Sales Year],
        [Sold To Party Sales Currency],
        [Sold To Party Sales Currency Description],
        [Sold To Party One Time Customer Acct Group],
        [Sold To Party One Time Customer Acct Group Description],
        [Sold To Party One Time Customer Indicator],
        [Sold To Party Industry Type],
        [Sold To Party Business Type],
        [Sold To Party DUNS Number],
        [Sold To Party DUNS Plus 4],
        [Sold To Party City Coordinates],
        [Sold To Party Tax Number 4 Code],
        [Sold To Party Attribute 3],
        [Sold To Party Attribute 3 Description],
        [Sold To Party E-Mail Address],
        [Sold To Party Mobile Number],
        [Sold To Party Search Term 2],
        [Sold To Party Street 2],
        [Sold To Party Street 3],
        [Sold To Party Street 4],
        [Sold To Party Street 5],
        [Sold To Party PO Box],
        [Sold To Party PO Box Postal Code],
        [Sold To Party PO Box City],
        [Sold To Party Region For PO Box],
        [Sold To Party PO Box Country],
        [Sold To Party Transport Zone],
        [Sold To Party Tax Number 3 Code],
        [Sold To Party Tax Number 5 Code],
        [Sold To Party Industry Code 3],
        [Sold To Party Industry Code 3 Description],
        [Sold To Party Industry Code 4],
        [Sold To Party Industry Code 4 Description],
        [Sold To Party Industry Code 5],
        [Sold To Party Industry Code 5 Description],
        [Sold To Party Central Order Block For Customer],
        [Sold To Party Payment Block],
        [Sold To Party Address Notes]
    )
    SELECT
        S.[CUST_ID],
        S.[CUST_KEY],
    ...
    LEFT JOIN [GLOBAL_EDW].[Propelis].[SOLD_TO_PARTY] AS T
        ON T.[CUST_KEY] = S.[CUST_KEY]
    WHERE T.[CUST_KEY] IS NULL
      AND S.[CUST_KEY] IS NOT NULL;
END;