CREATE     PROCEDURE [dbo].[Proc_EDW_T_D_FI_ICPTRDG_CUR_D]
AS
BEGIN
    ...
    INSERT INTO [GLOBAL_EDW].[dbo].[EDW_T_D_FI_ICPTRDG_CUR_D]
    (
        [PROFT_CNTR_ID],
        [TRADING_PRTNR]
