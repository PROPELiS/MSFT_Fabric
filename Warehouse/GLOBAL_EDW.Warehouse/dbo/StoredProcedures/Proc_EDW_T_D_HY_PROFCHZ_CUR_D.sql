CREATE   PROCEDURE dbo.Proc_EDW_T_D_HY_PROFCHZ_CUR_D
AS
BEGIN
    -- Step 1: Remove all existing data from Warehouse target table
    TRUNCATE TABLE dbo.EDW_T_D_HY_PROFCHZ_CUR_D;

    -- Step 2: Load data from Lakehouse source table into Warehouse target table
    INSERT INTO dbo.EDW_T_D_HY_PROFCHZ_CUR_D
    (
        [PROFT_CNTR_KEY],
    ...
    SELECT
        ...
        LVL_9_ID,
        LVL_9_DESC
    FROM [GLOBAL_EDW_MIRROR].[dbo].[EDW_T_D_HY_PROFCHZ_CUR_D];
