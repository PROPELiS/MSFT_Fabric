CREATE       PROCEDURE [dbo].[Proc_EDW_T_D_MST_CRNCY_CUR_D]
AS
BEGIN
    ...
    FROM [GLOBAL_EDW].[dbo].[EDW_T_D_MST_CRNCY_CUR_D] AS T
    INNER JOIN [GLOBAL_EDW_QA].[GLOBAL_EDW].[EDW_T_D_MST_CRNCY_CUR_D] AS S
        ON T.[CRNCY_KEY] = S.[CRNCY_KEY];

    INSERT INTO [GLOBAL_EDW].[dbo].[EDW_T_D_MST_CRNCY_CUR_D]
    (
        [CRNCY_KEY],
        [Currency Code],
        [ETL_SRC_SYS_CD],
    ...
    LEFT JOIN [GLOBAL_EDW].[dbo].[EDW_T_D_MST_CRNCY_CUR_D] T
        ON T.[CRNCY_KEY] = S.[CRNCY_KEY]
