CREATE   PROCEDURE [dbo].[Proc_MERGED_ORDER_TEST] (@LoadType VARCHAR(10))   -- 'FULL' or 'DELTA'
AS
BEGIN
    ...
    BEGIN
        ...
        TRUNCATE TABLE [GLOBAL_EDW].[dbo].[MERGED_ORDER_TEST];

        INSERT INTO [GLOBAL_EDW].[dbo].[MERGED_ORDER_TEST]
        (
            [ORDER_KEY],
            [Order Type],
            [Order Category],
    ...
    BEGIN
        ...
        MERGE INTO [GLOBAL_EDW].[dbo].[MERGED_ORDER_TEST] AS T
        USING 
        (
            SELECT 
			    S.[ORDER_KEY],
